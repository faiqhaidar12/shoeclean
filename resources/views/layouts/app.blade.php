    ...
    <body class="bg-gray-50" x-data="{ sidebarOpen: false }">
        <div class="min-h-screen flex">
            ...
            >
                ...
                <!-- Outlet Switcher / Info -->
                @if(auth()->user()->isOwner())
                    <div class="px-3 pt-3">
                        <livewire:outlet-switcher />
                    </div>
                @elseif(auth()->user()->outlet)
                    <div class="px-3 pt-3">
                        <div class="px-4 py-3 bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-100 shadow-sm">
                            <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-1.5 flex items-center gap-1">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/></svg>
                                Outlet
                            </p>
                            <p class="text-sm font-bold text-gray-800 truncate" title="{{ auth()->user()->outlet->name }}">
                ...
                <div class="p-4 border-t border-gray-100">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-xs text-gray-500 capitalize">{{ ucfirst(auth()->user()->roles->first()?->slug ?? 'User') }}</p>
                        </div>
