<div class="py-8">
    ...
    <div class="mb-12">
        ...
        <h1 class="headline-editorial text-4xl lg:text-5xl italic">Registri Outlet Baru</h1>
    </div>
            ...
            <form wire:submit="save" class="space-y-10">
                <div class="grid grid-cols-1 gap-10">
                    <div>
                        ...
                        <p class="text-[9px] text-artisan-primary/30 mt-2 font-bold uppercase tracking-widest">Slug Preview: <span class="text-artisan-secondary">{{ $slug ?: '-' }}</span></p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-10">
                        ...
                        <div class="rounded-[2rem] border border-slate-100 bg-slate-50/60 p-6">
                            ...
                            <p class="text-[11px] leading-relaxed text-artisan-primary/55 font-bold">Aktifkan jemput atau antar hanya jika cabang ini memang melayani area rumah pelanggan.</p>
                        </div>
                    </div>
                        ...
                        <div class="rounded-[2rem] border border-slate-100 bg-slate-50/50 p-6 space-y-5">
                            <label class="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <p class="mt-2 text-[11px] font-bold leading-relaxed text-artisan-primary/50">Cabang bisa menjemput sepatu dari alamat pelanggan.</p>
                                </div>
                        ...
                        <div class="rounded-[2rem] border border-slate-100 bg-slate-50/50 p-6 space-y-5">
                            <label class="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <p class="mt-2 text-[11px] font-bold leading-relaxed text-artisan-primary/50">Cabang bisa mengantar sepatu kembali ke alamat pelanggan.</p>
                                </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <p class="text-[9px] text-artisan-primary/30 mt-2 font-bold uppercase tracking-widest">Opsional. QRIS ini akan tampil di halaman sukses order outlet ini.</p>
                        ...
                        @if ($qris_image)
                            <div class="rounded-[2rem] border border-slate-100 bg-slate-50/50 p-6">
                                <p class="text-[9px] font-black uppercase tracking-widest text-artisan-secondary mb-4">Preview QRIS</p>
                                <img src="{{ $qris_image->temporaryUrl() }}" alt="Preview QRIS outlet" class="max-h-80 rounded-2xl border border-slate-100 bg-white object-contain">
                            </div>
                        @endif
                ...
                <div class="flex flex-col sm:flex-row gap-6 pt-6">
                    <a href="{{ route('outlets.index') }}" class="btn-artisan-secondary flex-1 text-center">Batalkan</a>
                    <button type="submit" class="btn-artisan-primary flex-1">Selesaikan Registri</button>
                </div>
            </form>
        </div>
    </div>
