<div class="py-8">
    ...
    <div class="mb-12">
        ...
        <h1 class="headline-editorial text-4xl lg:text-5xl italic">Rekrut Artisan Baru</h1>
    </div>
        ...
        <div class="card-artisan p-10 lg:p-16">
            <form wire:submit="save" class="space-y-12">
                <div class="space-y-10">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-10">
                        <div>
                            <label class="block text-[10px] font-black text-artisan-primary/40 uppercase tracking-widest mb-4">Kata Sandi *</label>
                ...
                <div class="flex flex-col sm:flex-row gap-6 pt-10">
                    <a href="{{ route('users.index') }}" class="btn-artisan-secondary flex-1 text-center">Batalkan Perekrutan</a>
                    <button type="submit" class="btn-artisan-primary flex-1">Selesaikan Perekrutan</button>
                </div>
            </form>
        </div>
    </div>
