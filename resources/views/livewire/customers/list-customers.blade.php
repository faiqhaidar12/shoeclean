        ...
        <div class="block lg:hidden space-y-3">
            @foreach($customers as $customer)
                <div class="card">
                    ...
                    <div class="flex items-center gap-2 mt-2 pl-13">
                        @if($customer->outlet)
                            <span class="inline-flex items-center gap-1 px-2 py-0.5 bg-primary-50 text-primary-700 text-xs rounded-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    @foreach($customers as $customer)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                @if($customer->outlet)
                                    <span class="inline-flex items-center gap-1 px-2.5 py-1 bg-primary-50 text-primary-700 text-xs font-medium rounded-full">
