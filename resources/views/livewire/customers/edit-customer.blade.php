<div class="py-8">
    ...
    <div class="mb-12">
        ...
        <h1 class="headline-editorial text-4xl lg:text-5xl italic">Ubah Data Pelanggan</h1>
    </div>
        ...
        <div class="card-artisan p-10 lg:p-16">
            <form wire:submit="save" class="space-y-12">
                <div class="space-y-10">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center gap-2">
                             ...
                             <span class="text-[8px] font-black uppercase tracking-widest text-artisan-primary/30">Pelanggan Aktif</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea wire:model="address" rows="4" class="artisan-input" placeholder="Masukkan alamat lengkap pelanggan..."></textarea>
                ...
                <div class="flex flex-col sm:flex-row gap-6 pt-10 border-t border-artisan-outline/10">
                    <a href="{{ route('customers.index') }}" class="btn-artisan-secondary flex-1 text-center">Batalkan Perubahan</a>
